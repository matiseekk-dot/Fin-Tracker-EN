...
const BASE_CATEGORIES = [
  { id: "rząd",        label: "Taxes/Gov",  icon: Building,   color: "#3b82f6", group: "essential" },
  { id: "rachunki",    label: "Bills",       icon: Zap,        color: "#f59e0b", group: "essential" },
  { id: "inwestycje",  label: "Investments",     icon: TrendingUp, color: "#8b5cf6", group: "essential" },
  { id: "jedzenie",    label: "Food",       icon: Utensils,   color: "#ef4444", group: "essential" },
  { id: "transport",   label: "Transport",      icon: Car,        color: "#f97316", group: "essential" },
  { id: "zdrowie",     label: "Health",        icon: Shield,     color: "#10b981", group: "essential" },
  { id: "zakupy",      label: "Shopping",         icon: ShoppingBag,color: "#06b6d4", group: "essential" },
  { id: "kawiarnia",   label: "Café",      icon: Coffee,     color: "#a78bfa", group: "lifestyle" },
  { id: "rozrywka",    label: "Entertainment",       icon: Gift,       color: "#ec4899", group: "lifestyle" },
  { id: "muzyka",      label: "Music",         icon: Gift,       color: "#f43f5e", group: "lifestyle" },
  { id: "ubrania",     label: "Clothing",        icon: ShoppingBag,color: "#818cf8", group: "lifestyle" },
  { id: "prezenty",    label: "Gifts",       icon: Gift,       color: "#e879f9", group: "lifestyle" },
  { id: "alkohol",     label: "Alcohol",        icon: Coffee,     color: "#2563eb", group: "lifestyle" },
  { id: "bukmacher",   label: "Betting",      icon: TrendingUp, color: "#dc2626", group: "lifestyle" },
  { id: "inne",        label: "Other",           icon: Wallet,     color: "#6b7280", group: "lifestyle" },
  { id: "przychód",    label: "Income",       icon: DollarSign, color: "#10b981", group: "income" },
  { id: "sprzedaż",    label: "Sales",       icon: DollarSign, color: "#34d399", group: "income" },
  { id: "dodatkowe",    label: "Extra Income",      icon: DollarSign, color: "#a3e635", group: "income" },
  { id: "bukmacherka", label: "Betting Income",    icon: DollarSign, color: "#fb923c", group: "income" },
];
...
const INITIAL_ACCOUNTS = [
  { id: 1, name: "Main Account",     type: "savings", bank: "Bank",      balance: 8500.00,  color: "#3b82f6", iban: "" },
  { id: 2, name: "Savings",     type: "savings", bank: "Bank",      balance: 3200.00,  color: "#06b6d4", iban: "" },
  { id: 3, name: "Investments",       type: "invest",   bank: "Broker",    balance: 9500.00,  color: "#8b5cf6", iban: "" },
  { id: 4, name: "Retirement Account",       type: "savings",  bank: "Broker",    balance: 1200.00,  color: "#10b981", iban: "" },
];
...
const INITIAL_PAYMENTS = [
  ...
  { id: 1, name: "Mortgage", type: "credit", amount: -1500.00, cat: "rachunki", acc: 1, color: "#3b82f6", freq: "monthly", dueDay: 10, trackPaid: true },
  { id: 2, name: "Car Loan", type: "credit", amount: -800.00, cat: "rachunki", acc: 1, color: "#f97316", freq: "monthly", dueDay: 20, trackPaid: true },
  // Rachunki
  { id: 3, name: "Rent",      type: "bill",   amount:  -700.00, cat: "rachunki", acc: 1, color: "#f59e0b", freq: "monthly", dueDay:  5, trackPaid: true, shared: false },
  { id: 4, name: "Internet",    type: "bill",   amount:  -100.00, cat: "rachunki", acc: 1, color: "#06b6d4", freq: "monthly", dueDay: 15, trackPaid: true },
  { id: 5, name: "Utilities",    type: "bill",   amount:  -200.00, cat: "rachunki", acc: 1, color: "#f59e0b", freq: "monthly", dueDay: 20, trackPaid: true },
  // Subskrypcje
  ...
  { id: 8, name: "Savings",  type: "savings", amount: -1000.00, cat: "inwestycje", acc: 1, color: "#10b981", freq: "monthly", dueDay: 10, trackPaid: true },
  { id: 9, name: "ETF Investment", type: "savings", amount:  -500.00, cat: "inwestycje", acc: 3, color: "#f59e0b", freq: "monthly", dueDay: 10, trackPaid: true },
];

const INITIAL_TEMPLATES = [
  { id: 1, desc: "Store",        amount: 50,    cat: "zakupy",    acc: 1 },
  { id: 2, desc: "Fuel",       amount: 200,   cat: "transport", acc: 1 },
  { id: 3, desc: "Restaurant",  amount: 80,    cat: "jedzenie",  acc: 1 },
  { id: 4, desc: "Coffee",         amount: 15,    cat: "kawiarnia", acc: 1 },
...
//    SAVINGS GOALS                                                              
const INITIAL_GOALS = [
  { id: 1, name: "Emergency Fund", target: 15000, saved: 5000, accId: 2, color: "#10b981", emoji: "🛡️" },
  { id: 2, name: "Vacation",          target: 8000,  saved: 1200, accId: 2, color: "#06b6d4", emoji: "🏖️" },
];

// DANE DEMONSTRACYJNE - zastąp własnymi transakcjami
const INITIAL_TRANSACTIONS = [
  // PRZYCHODY
  { id:  1, date: "2026-03-25", desc: "Salary",         amount:  7500.00, cat: "przychód",   acc: 1 },
  { id:  2, date: "2026-03-10", desc: "Bonus",           amount:  1200.00, cat: "przychód",   acc: 1 },

  // RACHUNKI
  { id:  3, date: "2026-03-10", desc: "Mortgage", amount: -1500.00, cat: "rachunki",  acc: 1 },
  { id:  4, date: "2026-03-05", desc: "Rent",            amount:  -700.00, cat: "rachunki",  acc: 1 },
  { id:  5, date: "2026-03-15", desc: "Internet",          amount:  -100.00, cat: "rachunki",  acc: 1 },
  { id:  6, date: "2026-03-20", desc: "Utilities",          amount:  -200.00, cat: "rachunki",  acc: 1 },

  // JEDZENIE
  { id:  7, date: "2026-03-22", desc: "Supermarket",         amount:  -180.00, cat: "jedzenie",  acc: 1 },
  { id:  8, date: "2026-03-18", desc: "Grocery Store",              amount:  -130.00, cat: "jedzenie",  acc: 1 },
  { id:  9, date: "2026-03-14", desc: "Restaurant",       amount:   -95.00, cat: "jedzenie",  acc: 1 },
  { id: 10, date: "2026-03-08", desc: "Groceries",  amount:  -160.00, cat: "jedzenie",  acc: 1 },

  // TRANSPORT
  { id: 11, date: "2026-03-21", desc: "Fuel",            amount:  -200.00, cat: "transport", acc: 1 },
  { id: 12, date: "2026-03-12", desc: "Fuel",            amount:  -180.00, cat: "transport", acc: 1 },
  { id: 13, date: "2026-03-17", desc: "Parking",           amount:   -30.00, cat: "transport", acc: 1 },

  // ZAKUPY
  { id: 14, date: "2026-03-16", desc: "Clothing Store",   amount:  -250.00, cat: "ubrania",   acc: 1 },
  { id: 15, date: "2026-03-11", desc: "Electronics",       amount:  -350.00, cat: "zakupy",    acc: 1 },

  // ROZRYWKA
  { id: 16, date: "2026-03-20", desc: "Cinema",              amount:   -40.00, cat: "rozrywka",  acc: 1 },
  ...
  { id: 20, date: "2026-03-19", desc: "Coffee",              amount:   -15.00, cat: "kawiarnia", acc: 1 },
  { id: 21, date: "2026-03-15", desc: "Coffee with friend", amount: -24.00, cat: "kawiarnia", acc: 1 },

  // INWESTYCJE
  { id: 22, date: "2026-03-10", desc: "ETF MSCI World",    amount: -1000.00, cat: "inwestycje", acc: 3 },
  { id: 23, date: "2026-03-10", desc: "Savings",      amount: -1000.00, cat: "inwestycje", acc: 2 },

  // ZDROWIE
  { id: 24, date: "2026-03-09", desc: "Pharmacy",            amount:   -45.00, cat: "zdrowie",   acc: 1 },
  { id: 25, date: "2026-03-03", desc: "Gym",          amount:   -80.00, cat: "zdrowie",   acc: 1 },
];
...
const XTB_PORTFOLIO = [
  // Konto inwestycyjne
  { ticker: "IWDA.AS", name: "iShares MSCI World",      type: "ETF",    account: "standard",
    qty: 50.0, avgPricePLN: 180.00, currentPricePLN: 188.50,
    valuePLN: 9425.00, pnlPLN: 425.00, pnlPct: 4.72, currency: "EUR" },
  // IKZE
  { ticker: "EUNL.DE", name: "iShares Core MSCI World", type: "ETF",    account: "IKZE",
    qty: 10.0, avgPricePLN: 95.00, currentPricePLN: 98.20,
    valuePLN: 982.00, pnlPLN: 32.00, pnlPct: 3.37, currency: "EUR" },
];
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8, background: "#060b14",
        ...
        <Select label="Category" value={tForm.cat}
...
const SettingsPanel = ({ open, onClose, accounts, transactions, budgets, payments, paid,
  ...
  const handleExport = () => {
    ...
    XLSX.utils.book_append_sheet(wb, wsBill, "Payments");
    ...
    if (customCats && customCats.length) {
      ...
      XLSX.utils.book_append_sheet(wb, wsCats, "Custom Categories");
    }
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 200, background: "rgba(0,0,0,0.85)",
      ...
      <div style={{ background: "#0d1628", border: "1px solid #1a2744", borderRadius: "20px 20px 0 0",
        ...
        <div style={{ background: "#060b14", border: "1px solid #1a2744", borderRadius: 10,
          ...
          {[
            ["Date",      "RRRR-MM-DD",  "#3b82f6"],
            ["Description",      "tekst",       "#10b981"],
            ["Amount",     "+/- liczba",  "#f59e0b"],
            ["Category", "np. jedzenie","#8b5cf6"],
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 600,
                ...
                {importStatus === "ok" ? "Import complete!" : importStatus === "err" ? "Import error" : "Loading…"}
              </div>
        ...
        <button
          onClick={() => {
            if (window.confirm("Are you sure? All your data will be deleted.")) {
              if (window.confirm("Are you sure? Save a backup before resetting!")) { window.location.reload(); }
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div>
              <div style={{ fontWeight: 700, fontSize: 13, color: urgent ? "#fca5a5" : "#86efac" }}>
                {urgent
                  ? daysSinceLast === 1 ? "You haven't added today's transactions!" : `Brak transakcji od ${daysSinceLast} dni!`
                  : `Dzisiaj: ${todayTxs.length} transakcj${todayTxs.length === 1 ? "a" : "e"}`
                }
              </div>
              <div style={{ fontSize: 11, color: "#475569", marginTop: 3 }}>
                {urgent
                  ? "Remember – every expense counts 💸"
...
const FinancialScore = ({ income, expense, transactions, month, cycleDay, elapsedDays }) => {
  ...
  const label = score >= 90 ? "Excellent" :
                score >= 75 ? "Good" :
                score >= 55 ? "Fair" :
                score >= 35 ? "Warning" : "Act Now";
  const sub   = score >= 75 ? "Finances in control" :
                score >= 55 ? "One thing to improve" :
                score >= 35 ? "Expenses need attention" :
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
            {[
              ...
              { lbl: "Expense", val: (expRatio*100).toFixed(0)+"%", ok: expRatio < 0.85 },
            ].map(({lbl,val,ok}) => (
...
const ExpenseTypesBreakdown = ({ monthTx, income }) => {
  ...
  const types = [
    { lbl: "Fixed",     val: fixed,      color: "#3b82f6", norm: 50 },
    { lbl: "Variable",   val: variable,   color: "#f59e0b", norm: 30 },
  ...
  return (
    <Card style={{ padding: "14px 16px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
        {[
          { lbl: "Pessimistic", val: projPes, sub: "if spending more" },
          { lbl: "Realistic",  val: projBase, sub: "at current pace" },
          { lbl: "Optimistic", val: projOpt, sub: "if spending less" },
        ].map(({ lbl, val, sub }) => (
...
const Recommendations = ({ income, expense, catData, monthTx, safeToSpend, daysLeft }) => {
  const recs = useMemo(() => {
    ...
    if (list.length === 0) {
      list.push({ emoji: "✓", text: "On track. Keep the pace — monthly goal is achievable." });
    }
    ...
    <div style={{ padding: "0 16px 100px", display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 16 }}>
          {[
            { label: "Income", val: income, color: "#10b981", Icon: ArrowDownLeft },
            { label: "Expenses",   val: expense, color: "#ef4444", Icon: ArrowUpRight },
            { label: "Balance",    val: balance, color: balance >= 0 ? "#10b981" : "#ef4444", Icon: balance >= 0 ? TrendingUp : TrendingDown },
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div>
              ...
              <div style={{ fontSize: 11, color: "#475569", marginTop: 4 }}>
                {safePerDay > 0
                  ? fmt(safePerDay) + "/dzien przez " + daysLeft + " days"
                  : "Budget exhausted"}
              </div>
            </div>
            <div style={{ textAlign: "right" }}>
      ...
      <Card>
        ...
        <ResponsiveContainer width="100%" height={120}>
          <LineChart data={histData}>
            ...
            <Tooltip contentStyle={{ background: "#0d1628", border: "1px solid #1a2744", borderRadius: 10, fontSize: 13 }}
              formatter={(v, n) => [fmt(Math.abs(v)), n === "balance" ? "Balance" : n]}/>
        ...
        <div style={{ display: "flex", gap: 16, marginTop: 8, justifyContent: "center" }}>
          {[["#10b981","Balance"],["#3b82f6","Income"]].map(([c,l]) => (
...
const AccountsView = ({ accounts, setAccounts }) => {
  ...
  const typeLabel = { checking: "Checking", savings: "Savings", invest: "Investments" };
  ...
  return (
    <div style={{ padding: "0 16px 100px" }}>
      ...
      {biezace.length > 0 && <>
        <SectionHeader label="💳 Checking Accounts" total={totalBiezace} color="#3b82f6"/>
      ...
      {oszcz.length > 0 && <>
        <SectionHeader label="🏦 Savings" total={totalOszcz} color="#06b6d4"/>
        <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 24 }}>
      ...
      {/* Inwestycje */}
      {inwest.length > 0 && <>
        <SectionHeader label="📈 Investments" total={totalInwest} color="#8b5cf6"/>
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      ...
      {/* Add / Edit modal */}
      <Modal open={modal} onClose={() => setModal(false)} title={editAcc ? "Edit Account" : "New Account"}>
        <Input label="Account Name" value={form.name} onChange={e => setForm(f => ({...f, name: e.target.value}))} placeholder="np. Konto osobiste"/>
        <Input label="Bank" value={form.bank} onChange={e => setForm(f => ({...f, bank: e.target.value}))} placeholder="np. PKO BP"/>
        <Input label="Balance (PLN)" type="number" value={form.balance} onChange={e => setForm(f => ({...f, balance: e.target.value}))} placeholder="0.00"/>
        <Select label="Account Type" value={form.type} onChange={e => setForm(f => ({...f, type: e.target.value}))}>
...
const TransactionsView = ({ transactions, setTransactions, accounts, setAccounts, allCats, _forceOpenModal, _onClose, _onModalClose, defaultAcc = 1 }) => {
  ...
  return (
    <div style={{ padding: "0 16px 100px" }}>
      ...
      <Modal open={modal} onClose={() => { setModal(false); setEditingId(null); }} title={editingId ? "Edit Transaction" : "New Transaction"}>
        <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
          {[["expense","📤 Expense","#ef4444"],["income","📥 Income","#10b981"],["transfer","🔄 Transfer","#60a5fa"]].map(([v,l,c]) => (
        ...
        {form.type === "expense" && (
          <Select label="Category" value={form.cat} onChange={e => setForm(f => ({...f, cat: e.target.value}))}>
        ...
        <Select label={form.type === "transfer" ? "Z konta" : "Account"} value={form.acc} onChange={e => setForm(f => ({...f, acc: e.target.value}))}>
          {[...accounts].sort((a,b) => {
        ...
        {form.type === "transfer" && (
          <Select label="To Account" value={form.toAcc} onChange={e => setForm(f => ({...f, toAcc: e.target.value}))}>
...
const BudgetView = ({ transactions, budgets, setBudgets, month, cycleDay = 1 }) => {
  ...
  return (
    <div style={{ padding: "0 16px 100px" }}>
      ...
      <Modal open={modal} onClose={() => setModal(false)} title="Set Budget Limit">
        <Select label="Category" value={form.cat} onChange={e => setForm(f => ({...f, cat: e.target.value}))}>
          {CATEGORIES.filter(c => c.id !== "przychód" && c.id !== "inne").map(c => <option key={c.id} value={c.id}>{c.label}</option>)}
        </Select>
        <Input label="Monthly Limit (PLN)" type="number" value={form.limit} onChange={e => setForm(f => ({...f, limit: e.target.value}))} placeholder="np. 1500"/>
...
const InvestmentsView = ({ accounts }) => {
  ...
  const zwykle = XTB_PORTFOLIO.filter(p => p.account === "standard");
  ...
  const histPerf = [{ m: "Now", val: totalValue }];
  ...
  return (
    <div style={{ padding: "0 16px 100px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 14 }}>
        {[
          { label: "Investments", val: zwykleVal, pnl: zwykle.reduce((s,p)=>s+p.pnlPLN,0), color: "#8b5cf6" },
          { label: "Retirement",       val: ikzeVal,   pnl: ikze.reduce((s,p)=>s+p.pnlPLN,0),   color: "#f59e0b" },
      ...
      <Card style={{ marginBottom: 14 }}>
        ...
        <ResponsiveContainer width="100%" height={110}>
          <AreaChart data={histPerf}>
            ...
            <XAxis dataKey="m" tick={{ fill: "#475569", fontSize: 13 }} axisLine={false} tickLine={false}/>
            <Tooltip contentStyle={{ background: "#0d1628", border: "1px solid #1a2744", borderRadius: 10, fontSize: 13 }} formatter={v => [fmt(v), "Value"]}/>
...
const MiniComparison = ({ transactions, month, cycleDay }) => {
  ...
  const rows = [
    { label: "Expenses",   cur: curExp,  diff: expDiff,  bad: expDiff > 0 },
    { label: "Income", cur: curInc,  diff: incDiff,  bad: incDiff < 0 },
  ];
...
const ForecastTab = () => {
  ...
  const chartData = Array.from({ length: years + 1 }, (_, i) => {
    ...
    return { rok: i === 0 ? "Now" : `${i}r`, wartość: Math.round(fS + fM), wpłacono: Math.round(startAmt + monthly * m) };
  });
  ...
  return (
    <div>
      <Card style={{ marginBottom: 14 }}>
        ...
        <Slider label="Monthly contribution" value={monthly} onChange={setMonthly} min={100} max={10000} step={100} fmtFn={v => fmt(v)} color="#3b82f6"/>
        <Slider label="Saving period" value={years} onChange={setYears} min={1} max={40} step={1} fmtFn={v => `${v} lat`} color="#8b5cf6"/>
        <Slider label="Annual return rate" value={rate} onChange={setRate} min={0} max={20} step={0.5} fmtFn={v => `${v}%`} color="#10b981"/>
        <div>
      ...
      <Card style={{ marginBottom: 14, background: "linear-gradient(135deg,#0d1e35,#0a1628)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
          {[
            { label: "Invested",    val: invested, color: "#94a3b8" },
            { label: "Return",   val: profit,   color: "#10b981" },
            { label: "Monthly", val: monthly,  color: "#f59e0b" },
          ].map(({ label, val, color }) => (
            <div key={label} style={{ background: "#060b14", borderRadius: 10, padding: "10px 8px", textAlign: "center" }}>
              <div style={{ fontSize: 9, color: "#475569", fontWeight: 700, textTransform: "uppercase", marginBottom: 4 }}>{label}</div>
      ...
      <Card>
        ...
        <ResponsiveContainer width="100%" height={180}>
          <AreaChart data={chartData}>
            ...
            <Tooltip contentStyle={{ background: "#0d1628", border: "1px solid #1a2744", borderRadius: 10, fontSize: 13 }}
              formatter={(v, n) => [fmt(v), n === "wartość" ? "Value" : "Invested"]}/>
        ...
        <div style={{ display: "flex", gap: 16, marginTop: 8, justifyContent: "center" }}>
          {[["#3b82f6","Portfolio value"],["#475569","Invested"]].map(([c,l]) => (
            <div key={l} style={{ display: "flex", alignItems: "center", gap: 5 }}>
              <div style={{ width: 12, height: 3, background: c, borderRadius: 2 }}/>
              <span style={{ fontSize: 10, color: "#475569" }}>{l}</span>
            </div>
  ...
  return (
    <div style={{ padding: "0 16px 100px" }}>
      ...
      <div style={{ display: "flex", gap: 6, paddingTop: 8, paddingBottom: 14 }}>
        {[["goals","🎯 Goals"],["limits","🚦 Limits"],["vacation","🏖️ Vacation"]].map(([t,l]) => (
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 11, marginTop: 2, color: over ? "#ef4444" : warn ? "#f59e0b" : "#475569" }}>
                        {over ? "! Over by " + fmt(spent - b.limit) : warn ? `🔶 Zostało tylko ${fmt(remain)}` : `Zostało ${fmt(remain)}`}
                      </div>
                    </div>
                  </div>
                  <div style={{ textAlign: "right" }}>
          ...
          <div>
            ...
            {budget > 0 && (
              <Card style={{ marginBottom: 14, background: isActive ? "linear-gradient(135deg,#0a1e12,#061610)" : undefined }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 14 }}>
                  {[
                    { label: "Spent",     val: spent,     color: pct > 80 ? "#ef4444" : "#e2e8f0" },
                    { label: "Remaining",    val: remaining, color: remaining < 0 ? "#ef4444" : "#10b981" },
                    { label: "Daily budget",   val: dailyBudget, color: "#60a5fa", suffix: "/dzień" },
                    { label: "Can spend today",  val: dailyLeft,   color: dailyLeft < 0 ? "#ef4444" : "#f59e0b", suffix: "/dzień" },
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
              <button
                onClick={() => {
                  if (!vacation.name) { alert("Enter vacation name before saving"); return; }
                  const entry = {
                    ...vacation,
                    id: Date.now(),
              ...
              <button
                onClick={() => {
                  if (!window.confirm("Clear current vacation and start new?")) return;
                        ...
                        {isOpen && (
                          <div style={{ borderTop: "1px solid #1a2744", padding: "14px 16px" }}>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 14 }}>
                              {[
                                { label: "Budget",    val: bgt,        color: "#e2e8f0" },
                                { label: "Spent",    val: v.spent,    color: pct > 100 ? "#ef4444" : "#f59e0b" },
      ...
      {/* Modal   nowy cel */}
      <Modal open={modal} onClose={() => { setModal(false); setEditGoal(null); }} title={editGoal ? "Edit Goal" : "New Goal"}>
        <div style={{ marginBottom: 14 }}>
        ...
        <Input label="Goal Name" value={form.name} onChange={e => setForm(f => ({...f, name: e.target.value}))} placeholder="np. Wakacje letnie"/>
        <Input label="Goal (PLN)" type="number" value={form.target} onChange={e => setForm(f => ({...f, target: e.target.value}))} placeholder="np. 8000"/>
        <Input label="Already Saved (PLN)" type="number" value={form.saved} onChange={e => setForm(f => ({...f, saved: e.target.value}))} placeholder="0"/>
        <Select label="Account" value={form.accId} onChange={e => setForm(f => ({...f, accId: e.target.value}))}>
      ...
      {/* Modal   nowy limit */}
      <Modal open={limitModal} onClose={() => setLimitModal(false)} title="New Monthly Limit">
        <Select label="Category" value={limitForm.cat} onChange={e => setLimitForm(f => ({...f, cat: e.target.value}))}>
          {CATEGORIES.filter(c => !["przychód","inne","sprzedaż","dodatkowe","bukmacherka"].includes(c.id)).map(c =>
            <option key={c.id} value={c.id}>{c.label}</option>
          )}
        </Select>
        <Input label="Monthly Limit (PLN)" type="number" value={limitForm.limit}
...
const PaymentsView = ({ payments, setPayments, paid, setPaid, transactions, setTransactions, accounts, month: globalMonth }) => {
  ...
  const isDueOverdue = (dueDay) => {
    const dueDate = `2026-${String(month + 1).padStart(2, "0")}-${String(dueDay).padStart(2, "0")}`;
  ...
  const togglePaid = (item) => {
    ...
    if (nowPaid) {
      ...
      const dueStr   = `2026-${String(month+1).padStart(2,"0")}-${String(item.dueDay||1).padStart(2,"0")}`;
  ...
  const freqLabel = (item) => {
    if (item.freq === "daily")   return "Daily";
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: 11, marginTop: 2, color:
            ...
            <span>{overdue ? "! Due date passed (" + item.dueDay + ".)" :
  ...
  const FREQ_LABELS = { monthly: "Monthly", bimonthly: "Every 2 months", weekly: "Weekly", daily: "Daily" };
  ...
  return (
    <div style={{ padding: "0 16px 100px" }}>
      ...
      <Section type="credit"  label="Liabilities"           emoji="🏦" color="#3b82f6" items={credits}/>
      <Section type="bill"    label="Bills"                emoji="📄" color="#f59e0b" items={bills}/>
      <Section type="sub"     label="Subscriptions"             emoji="🔄" color="#8b5cf6" items={subs}/>
      <Section type="savings" label="Savings Goals"    emoji="💰" color="#10b981" items={savings}/>
      ...
      <Modal open={modal} onClose={() => { setModal(false); setEditItem(null); }}
             title={editItem ? "Edit" : form.type === "credit" ? "New Liability" : form.type === "sub" ? "New Subscription" : form.type === "savings" ? "New Savings Goal" : "New Bill"}>

        {/* Type tabs in modal */}
        {!editItem && (
          <div style={{ display: "flex", gap: 6, marginBottom: 16 }}>
            {[["credit","🏦 Liability"],["bill","📄 Bill"],["sub","🔄 Subscription"],["savings","💰 Savings"]].map(([t,l]) => (
        ...
        <Input label="Name" value={form.name} onChange={e => setForm(f => ({...f, name: e.target.value}))} placeholder={
          form.type === "credit" ? "np. Kredyt hipoteczny" :
          form.type === "sub"    ? "np. Netflix" : "np. Prąd"}/>
        <Input label="Monthly Amount (PLN)" type="number" value={form.amount}
        ...
        <Select label="Account" value={form.acc} onChange={e => setForm(f => ({...f, acc: e.target.value}))}>
          {accounts.map(a => <option key={a.id} value={a.id}>{a.name}</option>)}
        </Select>
        ...
        {form.freq === "weekly" && (
          <Select label="Day of week" value={form.dayOfWeek} onChange={e => setForm(f => ({...f, dayOfWeek: e.target.value}))}>
            {["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"].map((d,i) =>
              <option key={i+1} value={i+1}>{d}</option>)}
          </Select>
        )}
        {(form.freq === "monthly" || form.freq === "bimonthly") && (
          <Input label="Day of month (due)" type="number" min="1" max="31"
            value={form.dueDay} onChange={e => setForm(f => ({...f, dueDay: e.target.value}))}/>
        )}
        {form.freq === "bimonthly" && (
          <Select label="First payment month" value={form.startMonth || new Date().getMonth()}
  ...
  return (
    <Card style={{ marginBottom: 14 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 14 }}>
        {[
          { label: "Expenses",   cur: curExp, cmp: cmpExp, isExp: true },
          { label: "Income", cur: curInc, cmp: cmpInc, isExp: false },
...
const AnalyticsView = ({ transactions, payments, paid, month, cycleDay = 1 }) => {
  ...
  const PERIOD_LABELS = { month: "Miesiąc", quarter: "Kwartał", half: "Półrocze", year: "Year" };
  ...
  return (
    <div style={{ padding: "0 16px 100px" }}>
      ...
      <div style={{ display: "flex", gap: 8, paddingTop: 8, paddingBottom: 14 }}>
        {[["month","Current"],["period","Periods"]].map(([v,l]) => (
      ...
      {activeView === "period" && (
        <div>
          ...
          <div style={{ display: "flex", gap: 6, marginBottom: 12 }}>
            {[["month","Month"],["quarter","Quarter"],["half","Half Year"],["year","Year"]].map(([v,l]) => (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 14 }}>
            {[
              { label: "Expenses",   val: periodTotal,                color: "#ef4444" },
              { label: "Wplywy",    val: periodIncTotal,             color: "#10b981" },
              { label: "Balance",    val: periodIncTotal-periodTotal, color: periodIncTotal-periodTotal >= 0 ? "#10b981" : "#ef4444" },
            ].map(({ label, val, color }) => (
          ...
          <div style={{ display: "flex", gap: 8, marginBottom: 14 }}>
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: "flex", gap: 6 }}>
                {[["cat","Category"],["place","Place"]].map(([v,l]) => (
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: "flex", gap: 4 }}>
                {[["total","Amount"],["count","Count"],["avg","Sr."]].map(([v,l]) => (
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 14 }}>
        {[
          { label: "Income", val: fmt(totalInc), color: "#10b981" },
          { label: "Expenses",   val: fmt(totalExp), color: "#ef4444" },
          { label: "Balance",    val: fmt(totalInc - totalExp, true), color: totalInc >= totalExp ? "#10b981" : "#ef4444" },
          { label: "Savings rate", val: `${savingsRate.toFixed(1)}%`, color: savingsRate >= 20 ? "#10b981" : "#f59e0b" },
        ].map(({ label, val, color }) => (
        ...
        return (
          <Card style={{ marginTop: 0 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: paidAmt > 0 ? 10 : 0 }}>
              {[
                { label: "Total", val: totalShared, color: "#e2e8f0" },
                { label: "Your half", val: halfTotal, color: "#60a5fa" },
                { label: "Partner's half", val: halfTotal, color: "#f59e0b" },
              ].map(({ label, val, color }) => (
...
export default function App() {
  ...
  }, [loaded, accounts, transactions, budgets, payments, paid, goals, month, cycleDay, customCats, defaultAcc]);
  ...
  const TABS = [
    ...
    { id: "payments",     label: "Payments",  Icon: ClipboardList, badge: unpaidBillsCount },
  ...
  if (!loaded) return (
    <div style={{ background: "#060b14", minHeight: "100vh", display: "flex",
      ...
      <div style={{ fontFamily: "'Space Grotesk', sans-serif",
        fontSize: 13, color: "#475569" }}>Loading...</div>
    </div>
  );
